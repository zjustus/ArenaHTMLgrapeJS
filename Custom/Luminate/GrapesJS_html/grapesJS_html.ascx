    ...
    <script type="text/javascript">
        const editor = grapesjs.init({
          ...
          storageManager: {
              ...
              autosave: <%= AutoSaveSetting %>,    // Store data automatically
              autoload: true,               // Autoload stored data on init
              stepsBeforeSave: <%= saveStepsSetting %>,          // If autosave enabled, indicates how many changes are necessary before store method is triggered
